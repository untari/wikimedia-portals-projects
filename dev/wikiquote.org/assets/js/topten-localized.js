...
( function ( mw, wmTest ) {
	...
	function updateTopLinkDOM( node, wikiInfo ) {
		...
		anchor.setAttribute( 'data-slogan', wikiInfo.slogan || 'Free quote compendium' );
	...
	function getAjaxTranslation( node, lang ) {
		...
		i18nReq.open( 'GET', encodeURI( 'portal/wikiquote.org/assets/l10n/' + lang + '-' + translationsHash + '.json' ), true );
